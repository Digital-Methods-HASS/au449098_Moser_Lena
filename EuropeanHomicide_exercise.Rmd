...
ggplot(data = Western_Europe, aes(x = Year, y = homicides_per_100k, color = Entity))+
  #....YOUR CODE GOES HERE
  geom_col()+
  labs(title = "Longterm trends in Homocide", y = "Homicides per 100k")
...
```{r Longerm Trends in Homicide, eval = TRUE}
ggplot(data = Western_Europe, aes(x = Year, y = homicides_per_100k, color = Entity))+
  #....YOUR CODE GOES HERE
  geom_col()+
...
kings %>% 
  ...
  geom_smooth()+
  labs(title = "Pattern of reign duration among Danish rulers", x = "Middle year", y = "Duration of reign")

#Duration of reign seems to become longer over time
...
ggplot(data = Western_Europe, aes(x = Year, y = homicides_per_100k, color = Entity))+
  ...
  labs(title = "Longterm trends in Homocide", y = "Homicides per 100k", colour = "Country")
...
Based on the visualisations it seems that European societies become less violent over time.